...
public class LiderSetorDAO extends GenericDAO {
	...
	/**
	 * Retorna uma lista simples dos lideres das Setors da tabela lider_rede
	 * @return
	 */
	...
	/**
	 * Retorna uma lista dos lideres das Setors e os dados do lider como nome, telefone... (tabelas lider_rede e membro)
	 * - Exemplo na view JSP: ${lista.get("membro").get("nome")} >> ${lista.get("nometabela").get("nomecoluna")}
	 * @return
	 */
	public ArrayList<HashMap<String,HashMap<String,String>>> getListaDadosLideresSetors(){
