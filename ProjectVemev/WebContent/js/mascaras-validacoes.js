...
/*
Descrição: Diversas funções de utilidade geral, tais como mascarar campos para CPF, telefone, CEP, etc.
*/
...
function validaExpressoes(field) {
...
function TrocarTabEnter(oEvent) {
    var oEvent = (oEvent) ? oEvent : event;
    var oTarget = (oEvent.target) ? oEvent.target : oEvent.srcElement;
    if (oEvent.keyCode == 9)
        oEvent.keyCode = 13;
    if (oTarget.type == "text" && oEvent.keyCode == 9)
    //return false;
        oEvent.keyCode = 13;
    if (oTarget.type == "radio" && oEvent.keyCode == 9)
        oEvent.keyCode = 13;
}
...
function formataCelular(campo, evt) {
    //(00) 00000-0000 - para SP
    //(00) 0000-0000 - para os demais
