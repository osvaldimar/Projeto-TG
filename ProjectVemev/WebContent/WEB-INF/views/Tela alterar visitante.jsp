					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-group col-md-3">
								...
								<div style="height: 59px;">
									<label for="txt_rdpertence">Pertence a alguma célula?</label><br><br><br><br>
									<input type="radio" name="pertence_celula" value="Sim">Sim&nbsp;&nbsp;
									<input type="radio" name="pertence_celula" value="Não">Não<br>
									<br>
								</div>
								<div style="height: 44px;">
									<label for="txt_rdoracao">Deseja oração?</label><br> 
							...
							<div class="form-group col-md-3">
								<div style="height: 59px;">
									<label for="slc_visitou">Visitou célula ou reunião?</label> 
								...
								<div style="height: 44px;">
									<label for="txt_oracao">Qual o motivo da oração?</label> 
									<input type="text" value="${visitante.motivo_oracao}" class="form-control" id="txt_oracao" name="motivo_oracao">
								</div>
							</div>
							<div class="form-group col-md-6">
								<div style="height: 59px;">
									<label for="txt_ajuda">Precisa de alguma ajuda específica?</label> 
									<input type="text" value="${visitante.precisa_ajuda}" class="form-control" id="txt_ajuda" name="precisa_ajuda">
								</div>
								<div style="height: 59px;">
									<label for="txt_descricao">O que chamou a atenção na reunião de celebração ou na célula?</label> 
